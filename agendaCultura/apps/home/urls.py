...
urlpatterns = [
    ...
    url(r'(?P<username>[-\w]+)/evento/(?P<id>[\d]+)/eliminar/p1$', actividad_delete_p1, name='actividad_delete_p1'),
    url(r'(?P<username>[-\w]+)/evento/(?P<id>[\d]+)/eliminar/p2$', actividad_delete_p2, name='actividad_delete_p2'),
