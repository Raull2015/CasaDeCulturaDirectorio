...
urlpatterns = [
    ...
    url(r'administracion/evento/$', views.actividad_authorize, name='autorizar_evento'),
    url(r'administracion/artista/$', views.artista_authorize, name='autorizar_artista'),
    url(r'administracion/evento/eliminar/$', views.actividad_delete, name='eliminar_evento'),
    url(r'administracion/artista/eliminar/$', views.artista_delete, name='eliminar_artista'),
